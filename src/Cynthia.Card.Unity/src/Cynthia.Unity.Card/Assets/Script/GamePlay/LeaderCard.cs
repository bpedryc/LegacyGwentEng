...
public class LeaderCard : MonoBehaviour
{
    ...
    public void SetLeader(CardStatus Leader,bool isCardCanUse)
    {
        ...
        if (isCardCanUse)
        {
            ...
            newCard.GetComponent<CardMoveInfo>().CardUseInfo = GwentMap.GetCard(Leader.CardId).CardUseInfo;//设置卡牌信息
        ...
        grayCard.GetComponent<CardMoveInfo>().CardUseInfo = GwentMap.GetCard(Leader.CardId).CardUseInfo;//设置卡牌信息
