...
namespace Cynthia.Card
{
    public static class GwentMap
    {
        ...
        public static IEnumerable<string> GetCreateCardsId(Func<CardStatus, bool> filter, Random rng, int count = 3,
            bool isHasDerive = false, bool isHasAgent = false)
        {
        ...
        {
            { Categorie.DoubleAgent, "double_agent" },
            { Categorie.WildHunt, "wild_hunt" },
            ...
            { Categorie.SiegeSupport, "siege_support" },
            { Categorie.ClanDrummond, "clan_drummond" },
            ...
            { Categorie.ClanTuirseach, "clan_tuirseach" },
            { Categorie.ClanTordarroch, "clan_tordarroch" },
            { Categorie.ClanDimun, "clan_dimun" },
            { Categorie.Witcher, "witcher" },
            { Categorie.Cultist, "cultist" },
            { Categorie.Alchemy, "alchemy" },
            { Categorie.Reckless, "reckless" },
            { Categorie.ClanHeymaey, "clan_heymaey" },
            ...
            { Categorie.ClanAnCraite, "clan_an_craite" },
            { Categorie.Dwarf, "dwarf" },
            { Categorie.Draconid, "draconid" },
            { Categorie.SiegeEngine, "siege_engine" },
            ...
            { Categorie.BlueStripes, "blue_stripes" },
            ...
            { Categorie.ClanBrokvar, "clan_brokvar" },
            { Categorie.Test, "test" },
        };
        ...
        public static GwentCard GetCard(string id)
        {
            var card = CardMap[id];

            card.Name = Translator?.GetText($"card_{card.CardId}_name");
            card.Info = Translator?.GetText($"card_{card.CardId}_info");
            card.Flavor = Translator?.GetText($"card_{card.CardId}_flavor");
        ...
        public static IDictionary<string, GwentCard> CardMap { get; } = new Dictionary<string, GwentCard>
        {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Flavor =
                        "I inherited my father's ability to assume other forms - well, one other form, in my case. ",
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Flavor =
                        "Dandelion told me all about your adventures. How'd he ready you for battle with his songs, how he tamed the kayran by playin' his lute...",
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Flavor =
                        "Apologies. My exotic pet's a clever birdie, but a wee bit lewd. Paid ten thalers for the beaute.",
                    Info =
                        "Choose One: Spawn a Companion that boosts 2 adjacent units by 2; or Spawn an Agitator that deals 2 damage to 2 adjacent units.",
                    CardArtsId = "11210900",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    HideTags = new HideTag[] {HideTag.Geralt},
                    Flavor =
                        "I accepted a job once, did it. Asked to choose my reward, I invoked the Law of Surprise. ",
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Flavor =
                        "\"Inconceivable. Impossible\", Ciri thought, returning to her senses. \"Unicorns don't exist, not any more, not in this world. Unicorns are extinct.\" ",
                    Info =
                        "Deal 5 damage to self. When the current power is equalt to the base power, deal 7 damage to 3 random enemy units at the end of the turn.",
                    CardArtsId = "20005100",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Gamble with Gaunter: Guess whether the power of the card he's picked has power lesser, equalt or greater than 6.",
                    CardArtsId = "13221500",
                }
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    HideTags = new HideTag[] {HideTag.Geralt},
                    Flavor =
                        "A blast of concentrated energy that pummels everything in its path. Great for when you forget your keys. ",
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Choose One: Spawn a Unicorn that boosts all units by 2; or Spawn a Chironex that deals 2 damage to all units.",
                    CardArtsId = "11210800",
                }
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    HideTags = new HideTag[] {HideTag.Geralt},
                    Flavor =
                        "He lay down next to Adda's mummified remains, drawing the Yrden Sign on the inner side of her sarcophagus' lid. ",
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    HideTags = new HideTag[] {HideTag.Triss},
                    Flavor =
                        "Bindings won't suffice. Nor will a gag render her any less dangerous. No, dimeritium is the only solution.",
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Flavor =
                        "What came first, the chicken or the egg? Compared to the conundrum that is the phoenix, the question seems downright trivial. ",
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Categories = new Categorie[] {Categorie.Mage, Categorie.Elf},
                    Flavor =
                        "Amongst the free elves were a handful of Aen Saevherne, or Sages. They were an enigma, bordering on a legend. ",
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Categories = new Categorie[] {Categorie.Cursed, Categorie.Relict},
                    Flavor =
                        "Ever heard of an \"anterion\"? Think of it as the opposite of a lycanthrope: a beast which can take on a human form. ",
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "If you have exactly 2 copies of each bronze in your deck, the base power of this card becomes 22 points.",
                    CardArtsId = "20162600",
                }
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Flavor =
                        "Vicovaro scholars have determined that, in the absence of imperial aid, drought-stricken provinces lose half their population, two-thirds of their livestock and all their will to rebel.",
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Flavor =
                        "We, Foltest, by divine right King of Temeria, Prince of Sodden, Senior Protector of Brugge, etcetera, etcetera, do hereby decree the following..",
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Flavor =
                        "Also known as 'the queen of poisons,' wolfsbane is used in many witcher Potions and alchemic brews",
                    Info =
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Flavor =
                        "This spell lets you see the last moment's of a dead man's life... if you can survive its casting. ",
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Categories = new Categorie[] {Categorie.Spell, Categorie.Special},
                    Flavor =
                        "I give you three solid leads, trails as fresh as morning dew, the aid of my spies and my court sorceress. Yet in my daughter's stead, you bring me this... monstrosity? ",
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Choose One: Deal 3 damage to all enemies with odd power; or Deal 3 damage to all enemies with even power; or Play a random Bronze or Silver unit from your deck.",
                    CardArtsId = "20163200",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Discard a card. Then make a copy of a card of the same color from your opponent's starting deck in your hand. ",
                    CardArtsId = "11221100",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Apply a Frost Hazard to 2 adjacent opposing rows. Frost Hazard: Every turn, at the start of your turn, Damage the Lowest Unit on the row by 2.",
                    CardArtsId = "11320600",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Apply a Hazard to an enemy row that will explode and deal 4 damage to all units when a different special card is played. Added to the game.",
                    CardArtsId = "20154800",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Send Shupe to the Imperial Court Military Academy. Strengthen yourself to 25; Gain resilience; Dual a unit; Reset a unit; Destroy all enemy units with power less than 4 points.",
                    CardArtsId = "20173700",
                }
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Flavor = "其他巨魔都觉得他是个异类，毕竟在巨魔们看来，谁会喜欢彩色纸片胜过喜欢石头呢？",
                    Info =
                        "Send Shupe to the forests of Dol Blathanna. Deal 15 damage; Deal 2 damage to a random enemy 8 times; Replay a bronze or silver unit and give it 5 points; Play a bronze or silver unit from your deck; Remove hazards on your side of the board a give boost your units by 1",
                    CardArtsId = "20173100",
                }
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Flavor = "其他巨魔都觉得他是个异类，毕竟在巨魔们看来，谁会喜欢彩色纸片胜过喜欢石头呢？",
                    Info =
                        "Send Shupe to the Ban Ard Academy. Draw 1 card; Charm a random enemy unit; Spawn a random hazard on all opponent's rows; Deal 10 damage to an enemy unit, than 5 damage to adjacent units; Play a special card from your deck.",
                    CardArtsId = "20172500",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Flavor = "画作传情，而非言词。",
                    Info =
                        "Deploy: Draw the top Gold card and top Silver card from your Deck. Play one and return the other to the top of your Deck. ",
                    CardArtsId = "13110200",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Deploy: Move 3 Enemies to this row on their side and Damage them by 2. If that row is affected by Frost Hazard, Damage them by 3 instead.",
                    CardArtsId = "20021800",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Spying. If Spying, boost self by 1 on turn start and when your opponent passes, move to the opposite row. Deathwish: Destroy the Lowest unit on the row.",
                    CardArtsId = "16221200",
                }
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Deploy: If this Unit was Revealed, Damage all Enemies by 1. Otherwise, Damage all Enemies except those on opposite row by 1.",
                    CardArtsId = "20004100",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Deal 2 damage to an enemy and all units that share its categories; or destroy a Bronze or Silver Neutral unit.",
                    CardArtsId = "20154000",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Flavor = "近卫军绝不投降，绝不。",
                    Info =
                        "Deploy: Boost self by 2 for each Spying Enemy. Whenever a Spying Enemy appears, Boost self by 2.",
                    CardArtsId = "16230700",
                }
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Deal 2 damage to an enemy. For each Spying enemy that appears during your turn, deal 2 damage to an enemy on turn end.",
                    CardArtsId = "16230800",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Flavor = "北方佬耍不出花招了。",
                    Info =
                        "Deploy: Choose a bronze or silver Revealed Unit in either Hand and Boost self by its base Power.",
                    CardArtsId = "16230300",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Deploy: Draw the top 2 Bronze Alchemy cards from your Deck. Play 1 and shuffle the other back. ",
                    CardArtsId = "12240300",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "After 2 turns, destroy the weakest non-Gold unit(s) on the row (except self). Banish when moved to the graveyard.",
                    CardArtsId = "16240200",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Play a random non-Spying Bronze or Silver unit from your deck and give it 5 Armor. 3 Armor.",
                    CardArtsId = "12220800",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Deploy: Damage an Enemy and up to 4 other random Enemies with the same Power by 1. Fresh Crew: Repeat the Deploy ability.",
                    CardArtsId = "12230100",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Choose 3 units. Strengthen allies by 2 and move them to this unit's row. Damage enemies by 2 and move them to the opposite row.",
                    CardArtsId = "14210500",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Ambush: When a unit is played from either hand on your opponent's side, flip over and deal 7 damage to that unit.",
                    CardArtsId = "14220800",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Deal damage equal to this unit's power. If a unit was destroyed, boost all your Dryad and Ambush units by 1, wherever they are.",
                    CardArtsId = "14220900",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Choose One: Play a Bronze or Silver Cursed unit from your deck; or Create a Silver unit from your opponent's deck.",
                    CardArtsId = "20010200",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Return a Bronze or Silver Skellige Unit from your Graveyard to your Hand and set its base Power to 8, then play a card from your Hand.",
                    CardArtsId = "15320100",
                }
            },
            {
            ...
            },
            {
                ...
                new GwentCard()
                {
                    ...
                    Info =
                        "Choose One: Resurrect a Bronze Beast or Cultist unit or Heal an ally and Strengthen it by 3.",
                    CardArtsId = "20159800",
                }
            },
            {
